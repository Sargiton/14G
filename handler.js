...
return
if (!m.fromMe && global.opts['self'])
return
if (global.opts['pconly'] && m.chat.endsWith('g.us'))
return
if (global.opts['gconly'] && !m.chat.endsWith('g.us'))
return
...
if (global.db.data.chats[m.chat].reaction && m.text.match(/(привет|как дела|дурак|бот|здраствуйте|🥰|💋₳VⱤØⱤ₳💋|tion|age|ous|ate|and|but|ify)/gi)) {
